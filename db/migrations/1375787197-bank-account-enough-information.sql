...
-- Note that this constraint does not allow routing numbers.
ALTER TABLE bank_account
    ADD CONSTRAINT enough_information CHECK (
        ...
        account_number IS NULL AND iban IS NOT NULL AND swiftbic IS NOT NULL AND routing_number IS NULL
);
