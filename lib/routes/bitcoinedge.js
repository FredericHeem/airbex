...
var BitcoinEdge = module.exports = function(dbClient) {
    this.db = dbClient || require('../db')()
}
...
BitcoinEdge.prototype.configure = function(app) {
    ...
    app.post('/private/deposit/' + that.options.securityId + '/address', function(req, res, next) {
