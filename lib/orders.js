...
var self = module.exports = {
    ...
    create: function(userId, bookId, side, price, volume, cb) {
        ...
        client.query(client.build.insert('"order"', {
            user_id: userId,
            book_id: bookId,
            price: price,
            volume: volume,
    ...
    configure: function(app) {
        app.post('/private/orders', function(req, res, next) {
            ...
            self.create(req.security.userId, req.params.book_id, +req.params.side,
                req.params.price, req.params.volume, function(err, id) {
