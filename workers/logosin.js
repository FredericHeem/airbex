var num = require('num')
, async = require('async')
, debug = require('debug')('snow:logosin')
, _ = require('lodash')
, util = require('util')
...
exports.setDbBalance = function(val, cb) {
    exports.db.query({
        text: 'UPDATE settings SET lgs_balance = $1',
        values: [val]
    }, cb)
}
...
exports.setDbHeight = function(height, cb) {
    ...
    exports.db.query({
        text: 'UPDATE settings SET logos_height = $1',
        values: [height]
    }, cb)
}
...
exports.credit = function(txid, address, satoshis, cb) {
    exports.db.query({
        text: 'SELECT address FROM lgs_deposit_address WHERE address = $1',
        values: [address]
    }, function(err, dr) {
        if (err) return cb(err)
        if (!dr.rowCount) {
        ...
        exports.db.query({
            text: 'SELECT lgs_credit($1, $2, $3) tid',
