...
, debug = require('debug')('snow:bitcoinout')
, db = require('./db')
, num = require('num')
, util = require('util')
, Q = require('q')
...
var BitcoinOut = module.exports = function() {
    var that = this

    this.client = db()
    this.bitcoin = new Bitcoin(config.BTC_HOST, config.BTC_PORT, config.BTC_USER, config.BTC_PASS)
