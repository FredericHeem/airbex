...
, CryptoLiability = require('../lib/cryptoliability')
...
debug("Crypto liability for currency %s, min conf %s", config.currency, config.minconf);
        ...
        [
         ...
         function(err) { 
            if (err)  {
                ...
                new CryptoLiability(cryptoEndPoint, dbClient)
            }
        });
